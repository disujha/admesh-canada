        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <article className="lg:col-span-9 space-y-16 text-sm text-white/55 leading-[1.9] font-light">
            ...
            <div id="introduction" style={{ scrollMarginTop: '100px' }}>
              ...
              <p className="mb-4">Welcome to AdMesh, operated by {COMPANY}, a company incorporated under the Companies Act, 2013 ("Company", "we", "us", "our"). These Terms of Service ("Terms") govern your access to and use of the AdMesh platform, including our website, brand dashboard, carrier portal, and all related services (collectively, the "Services").</p>
              ...
              <div className="bg-amber/5 border border-amber/20 rounded-xl p-5">
                <p className="text-amber/80 text-sm"><strong>Important:</strong> If you do not agree to these Terms, please do not access or use our Services. Continued use constitutes acceptance.</p>
              </div>
            </div>
            ...
            <div id="definitions" style={{ scrollMarginTop: '100px' }}>
              ...
              <div className="space-y-3">
                {[
                  ...
                  { term: '"Proof of Display"', def: 'GPS-tagged, AI-verified photographic evidence of active display at a Node, cryptographically sealed on blockchain.' },
                  ...
                  <div key={i} className="flex gap-4 p-4 bg-white/[0.02] border border-white/5 rounded-xl">
                    <div><strong className="text-amber/70">{item.term}:</strong> {item.def}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div id="eligibility" style={{ scrollMarginTop: '100px' }}>
              ...
              <p className="mb-4">To use our Services, you must be at least 18 years of age and legally capable of entering into binding contracts under Indian law. By using the Platform, you represent and warrant that you meet these requirements.</p>
              <div className="space-y-3">
                {[
                  'You agree to provide accurate, current, and complete information during registration.',
                  'You are responsible for maintaining the confidentiality of your account credentials.',
                  'You must notify us immediately at ' + CONTACT + ' if you suspect unauthorised access to your account.',
            ...
            <div id="services" style={{ scrollMarginTop: '100px' }}>
              ...
              <div className="space-y-3">
                {[
                  ...
                  'AI-powered photo verification and blockchain-sealed proof records',
                  ...
                  'Ground-agent managed physical installation and audit services',
                ].map((item, i) => (
                  <div key={i} className="flex items-start gap-3">
                    <span className="w-1 h-1 rounded-full bg-amber/40 mt-2 shrink-0" />
                    <span>{item}</span>
            ...
            <div id="brand-obligations" style={{ scrollMarginTop: '100px' }}>
              ...
              <div className="space-y-3">
                {[
                  'Ensure all creative content submitted to the Platform complies with applicable Indian advertising standards, including guidelines issued by the Advertising Standards Council of India (ASCI).',
                  ...
                  'Not use the Platform to run campaigns for categories prohibited under applicable law, including tobacco, alcohol targeting minors, or unlicensed financial products.',
                ].map((item, i) => (
                  <div key={i} className="flex items-start gap-3">
                    <span className="w-1 h-1 rounded-full bg-amber/40 mt-2 shrink-0" />
                    <span>{item}</span>
            ...
            <div id="carrier-obligations" style={{ scrollMarginTop: '100px' }}>
              ...
              <div className="space-y-3">
                {[
                  'Provide accurate information about your store, including location, store type, and estimated daily footfall.',
            ...
            <div id="payments" style={{ scrollMarginTop: '100px' }}>
              <div className="flex items-center gap-3 mb-6">
                <Scale size={18} className="text-amber/60" />
                <h2 className="text-2xl font-bold text-dirty-white tracking-tight">7. Payments & Billing</h2>
              </div>
              <div className="space-y-4">
                {[
                  { title: '7.1 Brand Partner Fees', desc: 'Campaigns are billed on a per-node, per-day basis. Applicable rates are ₹12/node/day (Self-Verified) or ₹20/node/day (Agent-Verified). GST at applicable rates will be charged additionally. All fees are exclusive of taxes unless stated.' },
                  { title: '7.2 Carrier Payouts', desc: 'Carrier earnings are calculated based on verified active display days and paid weekly via UPI to the registered account. Payments are subject to TDS deductions as per applicable income tax provisions.' },
                  { title: '7.3 Non-Payment', desc: 'Brand Partners who fail to pay invoices within 15 days of due date may have their campaigns suspended. We reserve the right to pursue recovery of outstanding amounts including through legal action.' },
                  ...
                  { title: '7.5 Disputes', desc: 'Any billing disputes must be raised within 30 days of invoice date by emailing ' + CONTACT + '. We will investigate and respond within 10 business days.' },
                ].map((item, i) => (
            ...
            <div id="prohibited" style={{ scrollMarginTop: '100px' }}>
              <div className="flex items-center gap-3 mb-6">
                <Ban size={18} className="text-amber/60" />
            ...
            <div id="disclaimers" style={{ scrollMarginTop: '100px' }}>
              <div className="flex items-center gap-3 mb-6">
                <AlertCircle size={18} className="text-amber/60" />
            ...
            <div id="termination" style={{ scrollMarginTop: '100px' }}>
              <div className="flex items-center gap-3 mb-6">
                <RefreshCw size={18} className="text-amber/60" />
            ...
            <div id="governing-law" style={{ scrollMarginTop: '100px' }}>
              <div className="flex items-center gap-3 mb-6">
                <Globe size={18} className="text-amber/60" />
                <h2 className="text-2xl font-bold text-dirty-white tracking-tight">14. Governing Law & Dispute Resolution</h2>
              </div>
              <p className="mb-4">These Terms shall be governed by and construed in accordance with the laws of India. The courts at Mumbai, Maharashtra shall have exclusive jurisdiction over any disputes arising from these Terms.</p>
            ...
            <div id="contact" style={{ scrollMarginTop: '100px' }}>
              ...
              <div className="bg-amber/5 border border-amber/20 rounded-2xl p-8 space-y-3">
                <div className="text-[10px] mono text-amber/50 uppercase tracking-widest mb-4">Contact Details</div>
                <p><strong className="text-white/70">Company:</strong> {COMPANY}</p>
                ...
                <p><strong className="text-white/70">Legal & Compliance:</strong> <a href={`mailto:${LEGAL}`} className="text-amber hover:underline">{LEGAL}</a></p>
              </div>
            </div>

            {/* Footer CTA */}
            <div className="bg-white/[0.02] border border-white/[0.06] rounded-3xl p-10 text-center">
              <p className="text-white/40 text-sm mb-6">Have a legal question or compliance concern?</p>
              <div className="flex flex-wrap justify-center gap-4">
                <a href={`mailto:${LEGAL}`} className="btn-molten px-8 h-[48px] inline-flex items-center gap-3 text-sm">
                  <Mail size={14} /> {LEGAL}
                </a>
                <Link href="/privacy" className="btn-ghost px-8 h-[48px] inline-flex items-center gap-3 text-sm">
